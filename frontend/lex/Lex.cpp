...
TokenType Scanner::getKeyword() {
    ...
    else if (buffer == "byte") return I8;
    else if (buffer == "ubyte") return U8;
    else if (buffer == "short") return I16;
    else if (buffer == "ushort") return U16;
    else if (buffer == "int") return I32;
    else if (buffer == "uint") return U32;
    else if (buffer == "int64") return I64;
    else if (buffer == "uint64") return U64;
